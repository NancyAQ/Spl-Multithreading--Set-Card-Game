...
class PlayerTest {
    ...
    @Test   //2 tests we wrote for 2 methods in the player class
    void setPenaltycheck(){ //testing if the method setpenalty changes players penalty,at default penalty is false
     player.setPenalty(true);
     assertTrue(player.penalty);
    }
    @Test
    void setPointcheck(){ //testing if the method setpenalty changes players penalty,at default penalty is false
        player.setPoint(true);
        assertTrue(player.point);
       }
