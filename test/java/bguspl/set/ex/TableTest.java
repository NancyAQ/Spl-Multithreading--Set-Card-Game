...
class TableTest {
    ...
    // test 1 made by us is for the method: emptyspots

    @Test
    void emptyspotscheck() {

        fillAllSlots();
        assertEquals(0, table.emptyspots());
    }

    // test 2 made by us is for the method: removeCard
    @Test
    void removeCardCheck() throws InterruptedException {
